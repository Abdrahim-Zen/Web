...
public class GestioneProdottiController extends ApplicationBaseController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        } else if ("updateProdotto".equals(azione)) {
            action_updateProdotto(request, response);
        } else {
    ...
    private void action_default(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<PresaInCarico> richiesteInCaricoDaRivalutare = new ArrayList<>();
            ...
            datamodel.put("richiesteDaRivalutare", richiesteInCaricoDaRivalutare);
    ...
    private void action_updateProdotto(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String prezzoProdottoStr = request.getParameter("prezzoProdotto");
            String idRichiestaInCaricoStr = request.getParameter("idRichiestaInCarico");
            System.err.println(idRichiestaInCaricoStr);
            // Validazione dei campi
            if (nomeProdotto == null || nomeProdotto.trim().isEmpty()
                    || descrizioneProdotto == null || descrizioneProdotto.trim().isEmpty()
                    || prezzoProdottoStr == null || prezzoProdottoStr.trim().isEmpty()
            ...
            dl.getProdottoCandidatoDAO().updateProdotti(descrizioneProdotto, prezzoProdotto, nomeProdotto, idRichiestaInCarico);
