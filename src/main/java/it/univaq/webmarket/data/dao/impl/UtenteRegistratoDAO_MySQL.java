    ...
    public void init() throws DataException {
        ...
        try {
            sUserByID = connection.prepareStatement(
                    "SELECT u.email, u.ID, u.nome, u.cognome, u.password, u.creato_da "
            ...
            sRegistedUserbyAdmin = connection.prepareStatement(" SELECT u.*  FROM utente u JOIN utenteRegistrato "
